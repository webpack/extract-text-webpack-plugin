...
Use `group` key to distinguish instance. There is also an `extract` function on each instance. You should use this if you have more than one instance of  `ExtractTextPlugin`.
