...
<a name="3.0.3"></a>
## [3.0.3](https://github.com/webpack-contrib/extract-text-webpack-plugin/compare/v3.0.2...v3.0.3) (2018-03-14)  
### update to support webpack4
  * replace plugin of compiler to hooks  
  * update chunk to chunkGroup
